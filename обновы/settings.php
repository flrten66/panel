    ...
    <div class="m-content">
        <div class="row">
        	<div class="col-lg-12">
                <div class="m-portlet m-portlet--brand m-portlet--head-solid-bg">
					...
					<div class="m-portlet__body">
						<ul class="m-widget27__nav-items nav nav-pills nav-fill" role="tablist">
							...
							<li class="m-widget27__nav-item nav-item">
								<a class="nav-link" data-toggle="pill" href="#hostinpl4">Информация и бонусы</a>
							</li>
						</ul>
						<hr>
						...
						<div class="m-widget27__tab tab-content m-widget27--no-padding">
							<div id="hostinpl1" class="tab-pane active show">
                                ...
                                <div class="form-group form-md-line-input">
                                    <label class="form-control-label">* Статистика хостинга</label>
                                    <select class="form-control" id="status_hostinpl" name="status_hostinpl" aria-required="true" aria-invalid="false" aria-describedby="delivery-error">
							...
							<div id="hostinpl2" class="tab-pane">
                                <div class="form-group form-md-line-input">
                                    <label class="form-control-label">* Модуль быстрой оплаты</label>
                                    <select class="form-control" id="oplata_status" name="oplata_status" aria-required="true" aria-invalid="false" aria-describedby="delivery-error">
                                ...
                                <div class="form-group form-md-line-input">
                                    <label class="form-control-label">* Платежная система быстрой оплаты</label>
                                    <select class="form-control" id="oplatahostinpl" name="oplatahostinpl" aria-required="true" aria-invalid="false" aria-describedby="delivery-error">
                                        <option value="robopay"<?php if($settings['oplatahostinpl'] == robopay): ?> selected="selected"<?php endif; ?>>Free-kassa</option>
                ...
                <div class="form-group form-md-line-input">
                  <label class="form-control-label">* Конвертация бонусов</label>
